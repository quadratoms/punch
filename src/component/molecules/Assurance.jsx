...
const headerStyle = "!items-center";
      ...
      <div className="flex-1">
        <div className="flex flex-col md:py-0 py-4  md:items-center justify-end w-full">
          <div className="relative">
            <img src={lady} className="absolute md:-top-52 hidden sm:block sm:right-10 md:-right-40" alt="" />
            <div
            ...
            <Steps
              ...
              items={[
                ...
                {
                  title: "Step 2",
                  description: "Give a short brief about your experience",
